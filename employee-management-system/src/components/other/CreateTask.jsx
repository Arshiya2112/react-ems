        ...
        <form className="flex flex-wrap w-full items-start justify-between">
          <div className="w-1/2">
            ...
            <div>
              ...
              <input className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="Desin, dev etc." />
            </div>
          </div>
          <div className="w-2/5 flex-col items-start">
            <h3 className="text-sm text-gray-300 mb-0.5">Description</h3>
            <textarea classNamew='full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' name="" id="" cols="30" rows="10" className="bg-white"></textarea>
